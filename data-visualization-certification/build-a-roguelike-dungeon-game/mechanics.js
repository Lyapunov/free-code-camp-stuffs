...
/*               while ( minimalLevelXp(characters[i][4].level+1) <= characters[i][6].xp ) {
         ...
         var ATTRIBUTES_OF_ENEMIES = [
             ...
             {name:"tough devilguy",scale:0.80,coloring:twoColors('crimson','tomato'),   slowness: 8,range:5,level:3,weakness:2,defaultWeapon:ATTRIBUTES_WOODEN_STICK},
             ...
             {name:"master thief" ,scale:1.00,coloring:masterTiefColors,                 slowness: 5,range:5,level:5,weakness:2},
             ...
             {name:"genie",scale:1.1,coloring:['green','green','green',"",'green',""],   slowness: 8,range:5,level:7,weakness:2,transparency:0.25},
             ...
             {name:"fire orb",scale:0.7,coloring:['yellow',"","","","",""],              slowness: 6,range:5,level:9,weakness:2,transparency:0.50},
             ...
             {name:"mercury golem",scale:0.95,coloring:twoColors('silver','silver'),     slowness: 4,range:5,level:9,weakness:2},
